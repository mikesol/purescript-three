module AST.Extras.Core.Shape where
...
ast = T.SourceFile
  { importDeclaration:
      ...
      , T.ImportDeclaration
          ...
          , stringLiteral: T.StringLiteral { text: "'./Path'" }
          }
      ]
  ...
  , classDeclaration_or_moduleDeclaration_or_firstStatement_or_exportDeclaration_or_typeAliasDeclaration_or_functionDeclaration_or_enumDeclaration:
      inj (Proxy :: Proxy "classDeclaration")
        [ T.ClassDeclaration
            ...
            , methodDeclaration:
                [ T.MethodDeclaration
                    { identifier: T.Identifier { text: "getPointsHoles" }
                ...
                , T.MethodDeclaration
                    { identifier: T.Identifier { text: "extractPoints" }
                    , typeReference_or_anyKeyword_or_parameter_or_voidKeyword_or_thisType_or_unionType_or_arrayType_or_stringKeyword_or_typeParameter_or_typeLiteral_or_numberKeyword_or_objectKeyword_or_staticKeyword_or_functionType_or_booleanKeyword_or_conditionalType:
                        inj (Proxy :: Proxy "parameter")
                          [ T.Parameter
                              { identifier: T.Identifier { text: "divisions" }
