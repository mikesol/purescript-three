module AST.Helpers.PointLightHelper where
          ...
          { importClause: T.ImportClause
              { namedImports_or_namespaceImport: inj
                  ...
                  ( T.NamedImports
                      { importSpecifier:
                          [ T.ImportSpecifier
                              { identifier: T.Identifier { text: "PointLight" }
                              }
                          ]
                      }
                  )
              }
          , stringLiteral: T.StringLiteral { text: "'./../lights/PointLight'" }
          }
      , T.ImportDeclaration
          { importClause: T.ImportClause
              { namedImports_or_namespaceImport: inj
  ...
  , classDeclaration_or_moduleDeclaration_or_firstStatement_or_exportDeclaration_or_typeAliasDeclaration_or_functionDeclaration_or_enumDeclaration:
      inj (Proxy :: Proxy "classDeclaration")
        [ T.ClassDeclaration
            ...
            , identifier: T.Identifier { text: "PointLightHelper" }
            , heritageClause: Just
                ( T.HeritageClause
            ...
            , constructor:
                [ T.Constructor
                    { parameter:
                        ...
                        , T.Parameter
                            { identifier: T.Identifier { text: "sphereSize" }
                            , typeReference_or_questionToken_or_numberKeyword_or_anyKeyword_or_unionType_or_stringKeyword_or_functionType_or_typeLiteral_or_objectKeyword_or_booleanKeyword_or_arrayType_or_thisType_or_intersectionType_or_dotDotDotToken_or_literalType:
