module AST.Materials.MeshLambertMaterial where
...
ast = T.SourceFile
  ...
  , interfaceDeclaration:
      [ T.InterfaceDeclaration
          ...
          , identifier: T.Identifier { text: "MeshLambertMaterialParameters" }
          , propertySignature:
              [ T.PropertySignature
                  { identifier: T.Identifier { text: "color" }
  ...
  , classDeclaration_or_moduleDeclaration_or_firstStatement_or_exportDeclaration_or_typeAliasDeclaration_or_functionDeclaration_or_enumDeclaration:
      inj (Proxy :: Proxy "classDeclaration")
        [ T.ClassDeclaration
            ...
            , identifier: T.Identifier { text: "MeshLambertMaterial" }
            , heritageClause: Just
                ( T.HeritageClause
                    { expressionWithTypeArguments: T.ExpressionWithTypeArguments
                        { identifier: T.Identifier { text: "Material" }
