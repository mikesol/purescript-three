module AST.Math.Interpolant where
        ...
        [ T.ClassDeclaration
            ...
            , constructor:
                [ T.Constructor
                    { parameter:
                        ...
                        , T.Parameter
                            { identifier: T.Identifier { text: "sampleValues" }
                            , typeReference_or_questionToken_or_numberKeyword_or_anyKeyword_or_unionType_or_stringKeyword_or_functionType_or_typeLiteral_or_objectKeyword_or_booleanKeyword_or_arrayType_or_thisType_or_intersectionType_or_dotDotDotToken_or_literalType:
                                inj (Proxy :: Proxy "anyKeyword")
                                  (T.AnyKeyword { text: "any" })
                            }
            ...
            , propertyDeclaration:
                [ T.PropertyDeclaration
                    { identifier: T.Identifier { text: "parameterPositions" }
            ...
            , methodDeclaration:
                [ T.MethodDeclaration
                    { identifier: T.Identifier { text: "evaluate" }
            ...
            , setAccessor: Nothing
            , getAccessor: []
            , firstContextualKeyword: Just
                (T.FirstContextualKeyword { text: "abstract" })
            }
        ]
