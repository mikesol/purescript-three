module AST.Textures.VideoTexture where
  ...
  , classDeclaration_or_moduleDeclaration_or_firstStatement_or_exportDeclaration_or_typeAliasDeclaration_or_functionDeclaration_or_enumDeclaration:
      inj (Proxy :: Proxy "classDeclaration")
        [ T.ClassDeclaration
            ...
            , identifier: T.Identifier { text: "VideoTexture" }
            , heritageClause: Just
                ( T.HeritageClause
            ...
            , constructor:
                [ T.Constructor
                    { parameter:
                        [ T.Parameter
                            { identifier: T.Identifier { text: "video" }
            ...
            , propertyDeclaration:
                [ T.PropertyDeclaration
                    { identifier: T.Identifier { text: "isVideoTexture" }
