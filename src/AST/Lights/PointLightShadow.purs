module AST.Lights.PointLightShadow where
  ...
  { importDeclaration:
      [ T.ImportDeclaration
          ...
          , stringLiteral: T.StringLiteral
              { text: "'./../cameras/PerspectiveCamera'" }
          }
      , T.ImportDeclaration
          { importClause: T.ImportClause
              { namedImports_or_namespaceImport: inj
  ...
  , classDeclaration_or_moduleDeclaration_or_firstStatement_or_exportDeclaration_or_typeAliasDeclaration_or_functionDeclaration_or_enumDeclaration:
      inj (Proxy :: Proxy "classDeclaration")
        [ T.ClassDeclaration
            ...
            , identifier: T.Identifier { text: "PointLightShadow" }
            , heritageClause: Just
                ( T.HeritageClause
                        ...
                        inj (Proxy :: Proxy "typeReference")
                          ( T.TypeReference
                              { identifier_or_firstNode_or_stringKeyword: inj
                                  ...
                                  (T.Identifier { text: "PerspectiveCamera" })
                              , typeReference: []
                              , anyKeyword: Nothing
                              , unionType: Nothing
                              , arrayType: Nothing
