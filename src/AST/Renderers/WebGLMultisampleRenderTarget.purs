module AST.Renderers.WebGLMultisampleRenderTarget where
              ...
              { namedImports_or_namespaceImport: inj
                  ...
                  ( T.NamedImports
                      { importSpecifier:
                          ...
                          , T.ImportSpecifier
                              { identifier: T.Identifier
                                  { text: "WebGLRenderTargetOptions" }
                              }
                          ]
                      }
                  )
              }
          , stringLiteral: T.StringLiteral { text: "'./WebGLRenderTarget'" }
          }
      ]
  ...
  , classDeclaration_or_moduleDeclaration_or_firstStatement_or_exportDeclaration_or_typeAliasDeclaration_or_functionDeclaration_or_enumDeclaration:
      inj (Proxy :: Proxy "classDeclaration")
        [ T.ClassDeclaration
            ...
            , identifier: T.Identifier { text: "WebGLMultisampleRenderTarget" }
            , heritageClause: Just
                ( T.HeritageClause
                    { expressionWithTypeArguments: T.ExpressionWithTypeArguments
                        { identifier: T.Identifier { text: "WebGLRenderTarget" }
                        , typeReference: []
                        }
                    }
                )
            ...
            , propertyDeclaration:
                [ T.PropertyDeclaration
                    { identifier: T.Identifier
                        { text: "isWebGLMultisampleRenderTarget" }
                ...
                , T.PropertyDeclaration
                    { identifier: T.Identifier { text: "samples" }
                    , stringKeyword_or_typeReference_or_numberKeyword_or_readonlyKeyword_or_literalType_or_unionType_or_booleanKeyword_or_functionType_or_typeLiteral_or_questionToken_or_arrayType_or_anyKeyword_or_staticKeyword_or_trueKeyword:
                        inj (Proxy :: Proxy "numberKeyword")
                          (T.NumberKeyword { text: "number" })
                    }
